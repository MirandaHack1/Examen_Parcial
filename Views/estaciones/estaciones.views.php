...
<body>
        ...
        <?php require_once('../html/header.php')  ?>
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>Estaciones</strong></h1>
                            ...
                            <div class="modal-dialog">
                                ...
                                <form id="usu_form">
                                    <div class="modal-body">
                                        <input type="hidden" name="ID_estacion" id="ID_estacion">
                                                    
                                                    <div class="form-group">
                                                        <label for="ciudad" class="control-label">ciudad</label>
                                                        <input type="text" name="ciudad" ID_estacion="ciudad" class="form-control" required>
                                                    </div>
                                                     <!--
                                                    <div class="form-group">
    ...
    <script src="./estaciones.views.js"></script> 
